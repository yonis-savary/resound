...
import AlbumCover from '~/components/albums/album-cover.vue'
import AlbumWishlistButton from '~/components/albums/album-wishlist-button.vue'
import ArtistLink from '~/components/artists/artist-link.vue'
import GenreLink from '~/components/genres/genre-link.vue'
import Tracklist from '~/components/tracks/tracklist.vue'
import YearLink from '~/components/years/year-link.vue'
